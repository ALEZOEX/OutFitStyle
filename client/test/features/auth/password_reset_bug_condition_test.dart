...
void main() {
  group('Password Reset Bug Condition Exploration Tests', () {
    ...
    group('Property: Server-Side Code Verification', () {
      test(
        'verifyResetCode makes network request to verify-reset-code endpoint',
        () async {
      ...
      test(
        'invalid code 000000 is rejected by server (counterexample)',
        () async {
      ...
      test(
        'invalid code 123456 is rejected by server (counterexample)',
        () async {
