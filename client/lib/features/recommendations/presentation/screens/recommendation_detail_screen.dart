...
class _RecommendationDetailScreenState
  ...
  Map<String, dynamic> _mapWardrobeItemToOutfitLine(domain.WardrobeItem w) {
    return <String, dynamic>{
      'id': w.id,
      'name': w.name,
      'category': w.category,
...
class CategoryReplacementWidget extends StatefulWidget {
  ...
  final domain.WardrobeItem? selected;
  final void Function(domain.WardrobeItem? picked) onSelected;
...
class _PickPage {
  ...
  factory _PickPage.alt(domain.WardrobeItem w) => _PickPage._(w.iconEmoji, w.name, w);
}
