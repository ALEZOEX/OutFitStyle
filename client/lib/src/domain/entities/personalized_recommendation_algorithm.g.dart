...
_$PersonalizedRecommendationAlgorithmImpl
    _$$PersonalizedRecommendationAlgorithmImplFromJson(
        ...
        _$PersonalizedRecommendationAlgorithmImpl(
          ...
          type: $enumDecodeNullable(
                  _$RecommendationAlgorithmTypeEnumMap, json['type']) ??
          ...
          weights: (json['weights'] as List<dynamic>?)
                  ...
                  .toList() ??
              const <String>[],
          personalizationLevel: $enumDecodeNullable(
...
Map<String, dynamic> _$$PersonalizedRecommendationAlgorithmImplToJson(
        _$PersonalizedRecommendationAlgorithmImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
