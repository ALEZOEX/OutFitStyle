...
// ignore: invalid_annotation_target
@JsonKey(name: 'is_archived') bool? get isArchived;/// Количество использований (носков)
// ignore: invalid_annotation_target
@JsonKey(name: 'wear_count') int? get wearCount;/// Дата последней носки
// ignore: invalid_annotation_target
@JsonKey(name: 'last_worn_at') DateTime? get lastWornAt;/// Сезон: all_season, spring, summer, autumn, winter
...
as bool?,wearCount: freezed == wearCount ? _self.wearCount : wearCount // ignore: cast_nullable_to_non_nullable
...
// ignore: invalid_annotation_target
@override@JsonKey(name: 'wear_count') final  int? wearCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,category,subcategory,brand,color,size,imageUrl,iconEmoji,blurHash,minTemp,maxTemp,warmthLevel,rainOk,snowOk,windOk,usage,const DeepCollectionEquality().hash(_materials),gender,fit,pattern,localImagePath,style,isFavorite,isArchived,wearCount,lastWornAt,season,serverId,dirty,lastSyncedAt]);
