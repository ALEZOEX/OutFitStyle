...
mixin _$Recommendation {
 ...
 int? get id; String? get title; String? get description;@JsonKey(name: 'image_url') String? get imageUrl; RecommendationType? get type; RecommendationSource? get source;@JsonKey(name: 'confidence_score') double? get confidenceScore;@JsonKey(name: 'created_at') DateTime? get createdAt;// Поля, которые используются в виджетах
...
/// Create a copy of Recommendation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? description = freezed,Object? imageUrl = freezed,Object? type = freezed,Object? source = freezed,Object? confidenceScore = freezed,Object? createdAt = freezed,Object? outfit = freezed,Object? occasion = freezed,Object? activity = freezed,Object? weather = freezed,Object? rating = freezed,Object? usageCount = freezed,Object? isFavorite = null,Object? isSaved = null,Object? isUsed = null,Object? recommendationReason = freezed,Object? tags = null,Object? userId = freezed,Object? outfitId = freezed,Object? weatherCondition = freezed,Object? recommendedItems = freezed,Object? metadata = freezed,Object? isLiked = freezed,Object? feedback = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? title,  String? description, @JsonKey(name: 'image_url')  String? imageUrl,  RecommendationType? type,  RecommendationSource? source, @JsonKey(name: 'confidence_score')  double? confidenceScore, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'outfit')@OutfitConverter()  Outfit? outfit,  String? occasion,  String? activity,  String? weather,  double? rating, @JsonKey(name: 'usage_count')  int? usageCount, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_saved')  bool isSaved, @JsonKey(name: 'is_used')  bool isUsed, @JsonKey(name: 'recommendation_reason')  String? recommendationReason,  List<String> tags, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'outfit_id')  int? outfitId, @JsonKey(name: 'weather_condition')  String? weatherCondition, @JsonKey(name: 'recommended_items')  List<String>? recommendedItems,  Map<String, dynamic>? metadata, @JsonKey(name: 'is_liked')  bool? isLiked,  String? feedback)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Recommendation() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.imageUrl,_that.type,_that.source,_that.confidenceScore,_that.createdAt,_that.outfit,_that.occasion,_that.activity,_that.weather,_that.rating,_that.usageCount,_that.isFavorite,_that.isSaved,_that.isUsed,_that.recommendationReason,_that.tags,_that.userId,_that.outfitId,_that.weatherCondition,_that.recommendedItems,_that.metadata,_that.isLiked,_that.feedback);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? title,  String? description, @JsonKey(name: 'image_url')  String? imageUrl,  RecommendationType? type,  RecommendationSource? source, @JsonKey(name: 'confidence_score')  double? confidenceScore, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'outfit')@OutfitConverter()  Outfit? outfit,  String? occasion,  String? activity,  String? weather,  double? rating, @JsonKey(name: 'usage_count')  int? usageCount, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_saved')  bool isSaved, @JsonKey(name: 'is_used')  bool isUsed, @JsonKey(name: 'recommendation_reason')  String? recommendationReason,  List<String> tags, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'outfit_id')  int? outfitId, @JsonKey(name: 'weather_condition')  String? weatherCondition, @JsonKey(name: 'recommended_items')  List<String>? recommendedItems,  Map<String, dynamic>? metadata, @JsonKey(name: 'is_liked')  bool? isLiked,  String? feedback)  $default,) {final _that = this;
switch (_that) {
case _Recommendation():
return $default(_that.id,_that.title,_that.description,_that.imageUrl,_that.type,_that.source,_that.confidenceScore,_that.createdAt,_that.outfit,_that.occasion,_that.activity,_that.weather,_that.rating,_that.usageCount,_that.isFavorite,_that.isSaved,_that.isUsed,_that.recommendationReason,_that.tags,_that.userId,_that.outfitId,_that.weatherCondition,_that.recommendedItems,_that.metadata,_that.isLiked,_that.feedback);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? title,  String? description, @JsonKey(name: 'image_url')  String? imageUrl,  RecommendationType? type,  RecommendationSource? source, @JsonKey(name: 'confidence_score')  double? confidenceScore, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'outfit')@OutfitConverter()  Outfit? outfit,  String? occasion,  String? activity,  String? weather,  double? rating, @JsonKey(name: 'usage_count')  int? usageCount, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_saved')  bool isSaved, @JsonKey(name: 'is_used')  bool isUsed, @JsonKey(name: 'recommendation_reason')  String? recommendationReason,  List<String> tags, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'outfit_id')  int? outfitId, @JsonKey(name: 'weather_condition')  String? weatherCondition, @JsonKey(name: 'recommended_items')  List<String>? recommendedItems,  Map<String, dynamic>? metadata, @JsonKey(name: 'is_liked')  bool? isLiked,  String? feedback)?  $default,) {final _that = this;
switch (_that) {
case _Recommendation() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.imageUrl,_that.type,_that.source,_that.confidenceScore,_that.createdAt,_that.outfit,_that.occasion,_that.activity,_that.weather,_that.rating,_that.usageCount,_that.isFavorite,_that.isSaved,_that.isUsed,_that.recommendationReason,_that.tags,_that.userId,_that.outfitId,_that.weatherCondition,_that.recommendedItems,_that.metadata,_that.isLiked,_that.feedback);case _:
  return null;
