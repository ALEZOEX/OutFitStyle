...
_RecommendationFeedback _$RecommendationFeedbackFromJson(
  ...
  likedItems:
      (json['likedItems'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
  dislikedItems:
      (json['dislikedItems'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
...
Map<String, dynamic> _$RecommendationFeedbackToJson(
  _RecommendationFeedback instance,
) => <String, dynamic>{
  'id': instance.id,
