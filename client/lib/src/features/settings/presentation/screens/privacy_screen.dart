            ...
            child: Column(
              children: [
                _buildToggle(
                  ...
                  onChanged: (value) => _saveSetting('profile_visibility', value),
                ),
                _buildToggle(
                  context,
                  ...
                  onChanged: (value) => _saveSetting('show_online_status', value),
                ),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                _buildToggle(
                  ...
                  onChanged: (value) => _saveSetting('stats_visibility', value),
                ),
                _buildToggle(
                  context,
                  ...
                  onChanged: (value) => _saveSetting('wardrobe_visibility', value),
                ),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                _buildToggle(
                  ...
                  subtitle: 'Помочь улучшить приложение, отправляя анонимные данные',
                  value: _allowDataCollection,
                  onChanged: (value) => _saveSetting('allow_data_collection', value),
                ),
              ],
            ),
          ),
  ...
  Future<void> _exportData() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Подготовка данных... Вы получите уведомление по завершении'),
