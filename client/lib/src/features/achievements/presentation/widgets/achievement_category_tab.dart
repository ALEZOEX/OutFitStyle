...
class AchievementCategoryTab extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AchievementCategoryTab> createState() =>
      _AchievementCategoryTabState();
}
...
class _AchievementCategoryTabState extends ConsumerState<AchievementCategoryTab>
      ...
      child: RefreshIndicator(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(child: _buildCategoryHeader(theme)),
            // Список достижений
            SliverPadding(
  ...
  Widget _buildCategoryHeader(ThemeData theme) {
    final categoryProgress = ref.watch(
      categoryProgressProvider(widget.category),
    );
