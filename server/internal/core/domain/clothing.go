...
type RecommendationResponse struct {
	ID          int64                `json:"id"`            // Уникальный идентификатор рекомендации
...
type RecommendationItem struct {
	ID             int64   `json:"id"`              // Уникальный идентификатор элемента
	ClothingItemID int64   `json:"clothing_item_id"` // Идентификатор элемента одежды
...
type Recommendation struct {
	ID        int64       `db:"id" json:"id"`              // Уникальный идентификатор рекомендации
...
type RecommendationItemEntity struct {
	ID               int64     `db:"id" json:"id"`                    // Уникальный идентификатор элемента
	RecommendationID int64     `db:"recommendation_id" json:"recommendation_id"` // Идентификатор рекомендации
	ClothingItemID   int64     `db:"clothing_item_id" json:"clothing_item_id"` // Идентификатор элемента одежды
